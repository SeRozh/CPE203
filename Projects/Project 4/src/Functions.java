...
public final class Functions
{
    ...
    */
    ...
    private static boolean parseOre(
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == WorldModel.ORE_NUM_PROPERTIES) {
            Point pt = new Point(Integer.parseInt(properties[WorldModel.ORE_COL]),
                                 Integer.parseInt(properties[WorldModel.ORE_ROW]));
            Entity entity = Factory.createOre(properties[WorldModel.ORE_ID], pt, Integer.parseInt(
                    properties[WorldModel.ORE_ACTION_PERIOD]),
                                      imageStore.getImageList( WorldModel.ORE_KEY));
            world.tryAddEntity(entity);
        }

        return properties.length == WorldModel.ORE_NUM_PROPERTIES;
    }
    // Don't move
